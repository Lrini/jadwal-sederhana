...
<?php 
    include '../koneksi.php';
    $id=$_GET['id'];
    $data = mysqli_query($koneksi,"SELECT * FROM katolik where id ='$id'");
    $edit = mysqli_fetch_array($data);
 ?>
    <table class="table table-bordered">
        <tr class="success"><th colspan="2">Edit Jadwal Katolik</th></tr>
         <tr>
          <td width="150">ID</td>
          <td>
            <div class='col-sm-4'>
...
if(isset($_POST['edit'])){
    ...
    $sql = mysqli_query($koneksi,"UPDATE katolik set tema='$tema',khotbah='$khotbah',tanggal ='$tanggal'where id='$id'
            ");
