...
if(isset($_POST['simpan'])){
   ...
   $tanggal=$_POST['tanggal'];
    ...
    $sql = mysqli_query($koneksi,"INSERT INTO kristen(tema,khotbah,tanggal)values 
...
<div class="tab-pane active" id="biodata">
    <table class="table table-bordered">
        <tr class="success"><th colspan="2">INPUT Jadwal Kristen Protestan</th></tr>
      <tr>
          <td>Tema Ibadah</td>
          <td>
              <div class="col-md-4">
...
<input type="reset"  value="RESET" class="btn btn-danger  btn-sm">
          ...
          <table id="dataTables" class="table table-bordered table-striped" >
                          ...
                          <tbody>
                            ...
                            $no = 1;
                            $res = $conn->query("select * from kristen");
                            while($row = $res->fetch_assoc()){
                              ...
                              <tr>
                                ...
                                <td>'.$row['tanggal'].'</td>
                                <td>
                                 <a href ="tambahkristen.php?id='.$row['id'].'"><i class="btn btn-block btn-primary btn-sm">edit</i></a>
                                 <a href ="hapuskristen.php?id='.$row['id'].'"><i class="btn btn-block btn-danger btn-sm">hapus</i></a>
                                </td>
                              </tr>
                              ';
                              $no++;
