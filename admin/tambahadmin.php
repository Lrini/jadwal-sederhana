...
<?php 
 ...
 ?>
    <table class="table table-bordered">
        <tr class="success"><th colspan="2">Edit Jadwal admin</th></tr>
         <tr>
          <td width="150">ID</td>
          <td>
            <div class='col-sm-4'>
        ...
        <tr>
          ...
          <td>
            <div class='col-sm-4'>
              <input type='text' name='nip' value="<?php echo $edit['nip'] ?>"  class='form-control' required='required' >
            </div>             
        </tr>
        <tr>
          ...
          <td>
            <div class='col-sm-4'>
              <input type='text' name='user' value="<?php echo $edit['user'] ?>"  class='form-control' required='required' >
            </div>             
        </tr>
        <tr>
          ...
          <td>
            <div class='col-sm-4'>
              <input type='text' name='pass' value="<?php echo $edit['pass'] ?>"  class='form-control' required='required' >
            </div>             
        </tr>
    </table>
...
if(isset($_POST['edit'])){
    ...
    $sql = mysqli_query($koneksi,"UPDATE login set nip='$nip',user='$user',pass ='$pass'where id='$id'
            ");
